...
** Magit
   #+BEGIN_SRC emacs-lisp
     (use-package magit
       ...
       :custom-face (magit-branch-current ((t (:foreground "cyan" :box (:line-width (3 . 3) :color "cyan" :style released-button)))))
       :config (setq magit-branch-arguments nil
                     magit-fetch-arguments '("--prune" "--tags")
...
** Shell
   #+BEGIN_SRC emacs-lisp
     (use-package sh-script
       ...
       (sh-mode-hook . (lambda () (setq tab-width 2 sh-basic-offset 2 indent-tabs-mode t))))
