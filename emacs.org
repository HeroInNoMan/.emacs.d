...
** Ivy, counsel, swiper
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package counsel-projectile
       :bind
       ("M-s j" . counsel-projectile)
       ("C-c C-j" . counsel-projectile-switch-project)
       ("<f9>" . counsel-projectile-switch-project)
       :config (setq counsel-projectile-switch-project-action #'ale/open-project))
...
* Org-mode
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package helm-org-ql
      :config (setq org-directory my-private-org-dir))
  #+END_SRC
     ...
     (pretty-hydra-define hydra-toggles
       ...
       ("Navigation"
        (("B" beginend-global-mode                      "begin-end"            :toggle t)
         ...
         ("k" (if (eq helm-split-window-default-side 'other)
                  (setq helm-split-window-default-side 'right)
                (setq helm-split-window-default-side 'other))        "helm toggle split")
     ...
     #+BEGIN_SRC emacs-lisp
       (use-package avandu
         :bind ( :map avandu-article-mode-map
                 ...
                 ("v" . scroll-up-command))
         :config
         (when (boundp 'my-private-personal-tt-rss-api-url)
           (setq avandu-tt-rss-api-url my-private-personal-tt-rss-api-url))
         (when (boundp 'my-private-personal-tt-rss-username)
           (setq avandu-user my-private-personal-tt-rss-username))
         (when (boundp 'my-private-personal-tt-rss-password)
           (setq avandu-password my-private-personal-tt-rss-password)))
     #+END_SRC
