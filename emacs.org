  ...
  #+BEGIN_SRC emacs-lisp
    (defhydra hydra-widgets (:color teal :hint nil)
      "
          ...
          _t_: ansi-term  _b_: eww-browser          _r_: rest-client     _é_: char-menu         _h_: Idle HL %`idle-highlight-mode
          _$_: shell      _B_: code browser         ^ ^                  ^ ^                    _H_: Highlight-line %`highlight-line-mode
          _%_: shell-pop  _c_: calendar             ^ ^                  ^ ^                    _I_: indent-guide %`highlight-indent-guides-mode
