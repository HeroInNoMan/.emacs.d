   ...
   #+BEGIN_SRC emacs-lisp
     (use-package company
       ...
       (setq company-tooltip-limit 30
             company-idle-delay 0.1 ;; almost no delay before showing candidates
             company-minimum-prefix-length 1 ;; completion rigth away!
       ...
       (pretty-hydra-define hydra-spell
         ...
         ("Spelling"
          ...
          (("s" powerthesaurus-lookup-word-dwim "synonym (DWIM)")
           ...
           ("." powerthesaurus-lookup-word-at-point "synonym at point")))))
