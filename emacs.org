...
* Package Management
  ...
  I decided to move to [[https://github.com/progfolio/elpaca][elpaca]] to manage my config, as it seems more solid and predictable.

  This is how elpaca itself is being bootstrapped:
  #+BEGIN_SRC emacs-lisp
...
* Emacs directory
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package no-littering
      ...
      (setq recentf-exclude '("~$" "/tmp/" "/ssh:" "/sshx:" "/sudo:"))
      (recentf-mode 1)
...
** Encoding
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package iso-transl :elpaca nil :defer t)
   #+END_SRC
...
* Modal editing
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package devil
      :elpaca '(devil :host github :repo "susam/devil")
...
** Zoom
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package font-size
       :elpaca '(font-size :host github :repo "nabeix/emacs-font-size")
       :bind
...
*** Icons in terminal
    #+BEGIN_SRC emacs-lisp
      (use-package font-lock+ :elpaca nil :defer t)
...
* Navigation
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package iy-go-to-char
      :elpaca '(iy-go-to-char :host github
...
*** [[https://github.com/minad/vertico/][Vertico]]
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package vertico
        ...
        (add-hook 'elpaca-after-init-hook #'file-name-shadow-mode)
        ...
        (setq vertico-extensions-path "elpaca/repos/vertico/extensions")
      ...
      (use-package vertico-multiform :elpaca nil
      ...
      (use-package vertico-buffer :elpaca nil :after vertico
        :load-path vertico-extensions-path
        :config (setq vertico-buffer-mode nil))

      (use-package vertico-directory :elpaca nil :after vertico
        :load-path vertico-extensions-path)

      (use-package vertico-flat :elpaca nil :after vertico
        :load-path vertico-extensions-path)

      (use-package vertico-grid :elpaca nil :after vertico
        :load-path vertico-extensions-path)

      (use-package vertico-indexed :elpaca nil :after vertico
        :load-path vertico-extensions-path)

      (use-package vertico-mouse :elpaca nil :after vertico
        :load-path vertico-extensions-path)

      (use-package vertico-reverse :elpaca nil :after vertico
        :load-path vertico-extensions-path)

      (use-package vertico-unobtrusive :elpaca nil :after vertico
        :load-path vertico-extensions-path)

      (use-package vertico-repeat :elpaca nil :after vertico
        :load-path vertico-extensions-path
        :hook (minibuffer-setup . vertico-repeat-save)
        :init (add-to-list 'savehist-additional-variables 'vertico-repeat-history))

      (use-package vertico-quick :elpaca nil :after vertico
        :load-path vertico-extensions-path
...
** Git tools
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package gitconfig-mode
       :after magit
       :elpaca '(gitconfig-mode :host github
                                :repo "magit/git-modes"
                                :files ("gitconfig-mode.el"))
       :mode ".gitconfig$")

     (use-package gitignore-mode
       ;; :disabled t ;; TODO fix this package for elpaca
       :after magit
       :elpaca '(gitignore-mode :host github
                                :repo "magit/git-modes"
...
* Org
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package org
      :elpaca (:type built-in) ;; compatibility problems between versions of org…
      ...
      ;;                       (color-lighten-name (face-attribute 'default :background) 15)))
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package verb
      ...
      (use-package ob-verb :elpaca nil :after org))

    (use-package ob-shell :elpaca nil :after org)
...
** Grammalecte
   #+BEGIN_SRC emacs-lisp
     (use-package flycheck-grammalecte
       :elpaca '(flycheck-grammalecte :depth nil)
       :defer t)
   #+END_SRC
...
** Dealing with parens
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package emacs-surround
       :elpaca (:host github :repo "ganmacs/emacs-surround")
...
** Lisp
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package paredit ;; cf. https://github.com/progfolio/elpaca/issues/40 (cloning of paredit fails)
...
** Logs
   #+BEGIN_SRC emacs-lisp
     (use-package syslog-mode :elpaca nil :defer t)
   #+END_SRC
...
* Mail
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package mu4e-goodies
      ...
      :elpaca '(mu4e-goodies :host github :repo "panjie/mu4e-goodies")
      :after mu4e)
  #+END_SRC
     ...
     (pretty-hydra-define hydra-widgets
       ...
       ("Shells"
        ...
        (("TAB" crux-cleanup-buffer-or-region "indent region")
         ...
         ("w" 0x0-dwim "webpaste"))
        "Packages"
        (("m" elpaca-manager "package manager")
         ("u" elpaca-update-all "update all packages"))))
...
** Restclient
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package impostman
       :defer t
       :elpaca '(impostman :host github :repo "flashcode/impostman"))
   #+END_SRC
...
*** Other
    #+BEGIN_SRC emacs-lisp
      (use-package 2048-game :defer t
        :elpaca '(2048-game :host github
                            :repo "emacsmirror/2048-game"))
                ...
                (cond
                 ((daemonp)
                  (progn
                    ...
                    (when (fboundp 'centaur-tabs-mode) (tab-bar-mode -1))
