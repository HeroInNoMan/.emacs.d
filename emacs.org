...
*** sql & company
    #+BEGIN_SRC emacs-lisp
      ...
      (use-package company-postgresql
        :straight '(company-postgresql :type git :host github :repo "urbint/emacs-postgresql-interactive")
        :config (add-to-list 'company-backends 'company-ob-postgresql))
    #+END_SRC
...
** Continuous integration
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package jenkins
       :config
       (setq jenkins-api-token "1113007ba7de342d99f1ed28005a47d34b"
             jenkins-url "https://integration.enercoop.org/"
             jenkins-username "arthur.leothaud"
             ;; jenkins-viewname "coopener_pipeline-deploy-2-instances"
             ))
   #+END_SRC
