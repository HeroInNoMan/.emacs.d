...
** Icons in terminal
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package icons-in-terminal
       ...
       :straight nil
       :defer t
       :load-path (expand-file-name ".local/share/icons-in-terminal/" my-home-dir))
...
* Navigation
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package dumb-jump
      ...
      :config (setq dumb-jump-default-project my-default-project-root))
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package helm-rg
       ...
       :bind ( :map helm-rg-map
               ...
               ("C-c C-e" . helm-rg--bounce))
       :config (setq helm-rg-default-directory (expand-file-name my-home-dir)))
   #+END_SRC
...
* Org-mode
  #+BEGIN_SRC emacs-lisp
    (use-package org
      ...
      (when (equal my-work-machine-name (system-name))
        (add-to-list 'org-capture-templates
                     '("l" "Log       (work)"
...
** Rust
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package cargo
       :after rust-mode
       :config (add-to-list 'exec-path (expand-file-name ".cargo/bin" my-home-dir)))
