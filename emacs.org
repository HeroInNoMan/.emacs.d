      ...
      (use-package rich-minority
        ...
        (progn
          ...
          (setq rm-text-properties '(
                                     ("\\` =>\\'"          'display "​ ➠") ; aggressive indent
                                     ("\\` Undo-Tree\\'"   'display (concat " " (propertize "⎌" 'face '((:foreground "darkolivegreen" :weight "bold")))))
                                     ("\\` God\\'"         'display (concat " " (icons-in-terminal 'linea_weather_cloud_lightning :weight "bold" :foreground "red" :background "black")))
                                     ("\\` ARev\\'"        'display " ↺") ; auto revert
                                     ("\\` DC\\'"          'display " ⇧") ; dup caps
                                     ("\\` Dot\\'"         'display " •") ; Dot-mode
                                     ("\\` Fill\\'"        'display " aF.")
                                     ...
                                     ("\\` FlyC\\-\\'"     'display (concat " " (propertize "✓-" 'face '((:foreground "red" :weight "bold"))))) ; flycheck
                                     ("\\` FlyC\\'"        'display (concat " " (propertize "✓" 'face '((:foreground "red" :weight "bold"))))) ; flycheck
                                     ("\\` FlyC:0/.*\\'" 'face '((:foreground "orange" :weight "bold"))) ; flycheck
                                     ("\\` FlyC.*\\'"       'face '((:foreground "red" :weight "bold"))) ; flycheck
                                     ...
                                     ("\\` Wrap\\'"        'display " ↩")   ; visual-line
                                     ("\\` abrv\\'"        'display " @")   ; Abbrev
                                     ("\\` mc:[0-9]+ *\\'" 'face 'font-lock-keyword-face) ; Multiple cursors
                                     ("\\` Projectile\\[.+\\]\\'" 'display "") ;  projectile
                                     ("\\` rk\\'"          'display (concat " " (propertize "[]" 'face 'font-lock-warning-face))) ; Region bindings
