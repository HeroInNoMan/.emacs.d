...
** Highlight feedback
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package highlight-line
       :ensure nil
       :config
       (custom-set-faces '(hl-line ((t (:background "grey7")))))
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package yasnippet
       ...
       (use-package auto-yasnippet
         :config
         (setq aya-persist-snippets-dir (concat base-emacs-directory "etc/yasnippet/snippets")))
...
** Dealing with parens
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package smartparens
       :hook ((prog-mode text-mode) . turn-on-smartparens-mode)
