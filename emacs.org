...
* Defaults
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package emojify
      :hook (text-mode . (lambda () (emojify-mode t))))
  #+END_SRC
        ...
        (setq ibuffer-saved-filter-groups
              '(("default"
                 ...
                 ("emacs" (or
                           (name . "^\\*scratch\\*$")
                           (name . "^\\*Messages\\*$"))))))
        (setq ibuffer-never-show-predicates '("\*helpful .*\*"
                                              "\*helm .*\*")))
    #+END_SRC
    ...
    (use-package mu4e-alert
      ...
      (setq
       ...
       mu4e-alert-interesting-mail-query (concat
                                          "flag:unread"
                                          " AND maildir:/INBOX"
                                          ;; " AND NOT maildir:/Folders/Enercoop-forward"
                                          ;; " AND NOT maildir:/Labels/Enercoop"
                                          ;; " AND NOT from:marinone"
                                          ;; " AND NOT from:easter-eggs.com"
                                          ;; " AND NOT to:enercoop.org"
                                          ;; " AND NOT list:\"Coopener.enercoop.github.com\""
                                          ;; " AND NOT flag:trashed"
                                          ;; " AND NOT maildir:/Junk"
                                          ;; " AND NOT subject:SPAM"
                                          ))
