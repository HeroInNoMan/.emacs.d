  ...
  #+BEGIN_SRC emacs-lisp
    (use-package org
      ...
      (setq notes-file (concat user-emacs-directory "notes.org")
            ...
            todo-ideas-file my-private-local-ideas-org-file
            ...
            '(;; LOCAL
              ...
              ("p" "prêt" ;; add a lend entry
               entry (file+headline  todo-local-file "Prêts / emprunts")
               "* PRÊT %i%?"
               :kill-buffer t)

              ("f" "film" ;; add a film in to-watch list
               entry (file+headline todo-media-file "Films")
               "* VOIR %i%?%^{Date}p"
               :prepend t :kill-buffer t)

              ("i" "idea" ;; add an idea entry
               item (file+headline todo-ideas-file "Pêle-mêle")
               "%i%?"
               :kill-buffer t)

              ("n" "note" ;; add a note
               item (file+olp+datetree notes-file)
               "%i%?"
               :kill-buffer t)
