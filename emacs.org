...
* Navigation
  I use [[https://github.com/abo-abo/ace-window][ace-window]],
  #+BEGIN_SRC emacs-lisp
  ...
  and [[https://github.com/muffinmad/emacs-ctrlxo][ctrlxo]], to quickly switch windows…
  #+BEGIN_SRC emacs-lisp
    (use-package ctrlxo
      :bind ("C-x o" . ctrlxo))
  #+END_SRC
      ...
      (setq org-super-agenda-groups
            '(;; Each group has an implicit boolean OR operator between its selectors.
              ...
              (:order-multi (2
                             ...
                             (:name "N E X T"
                                    :face ( :foreground "Darkolivegreen2"
                                            :weight bold)
                                    :and ( :todo "NEXT")) ))
              ...
              (:name "T R A V A I L"
                     ...
                     :face ( :foreground "gold"
                             :weight bold)
                     :and ( :todo ("TODO" "NEXT" "PROJECT" "STARTED" "WIP")
                            :scheduled t
                            :not (:priority< "B")
                            :tag ("enercoop" "work" "travail")))

              (:name "A U J O U R D ’ H U I"
                     :order 5
                     :and ( :scheduled today
                            :not (:habit t)
                            :todo "TODO"))
