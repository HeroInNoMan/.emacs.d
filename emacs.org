...
* Dired
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package dired
      :ensure nil
      :init (unbind-key "M-b" dired-mode-map)
...
* Quick access
  #+BEGIN_SRC emacs-lisp
    ...
    (defhydra hydra-widgets (:color teal)
      ...
      ;; Built-in
      ("e" eshell "eshell" :column "Built-in")
      ("G" gnus "Gnus")
