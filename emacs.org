...
** Custom menu
   #+BEGIN_SRC emacs-lisp
     (defhydra hydra-minor-modes(:color blue :hint nil)
       ...
       ^Minor mode^    ^Toggle
       ^──────────^────^──────^───────────────────
       _q_  quit       _(_ smartparens %(when (boundp 'smartparens-mode) smartparens-mode)
       ^ ^             _)_ smartparens strict %(when (boundp 'smartparens-mode) smartparens-strict-mode)
       ^ ^             _c_ color-identifiers-mode %(when (boundp 'color-identifiers-mode) color-identifiers-mode)
       ^ ^             _g_ god %(when (boundp 'god-local-mode) god-local-mode)
       ^ ^             _h_ Idle HL %(when (boundp 'idle-highlight-mode) idle-highlight-mode)
       ^ ^             _H_ Highlight-line %(when (boundp 'highlight-line-mode) highlight-line-mode)
       ^ ^             _i_ ido %(when (boundp 'ido-mode) ido-mode)
       ...
       ^ ^             _V_ volatile-highlight %(when (boundp 'volatile-highlights-mode) volatile-highlights-mode)
       ^ ^             _w_ whitespace %`global-whitespace-mode
       ^ ^             _x_ winnow-mode %(when (boundp 'winnow-mode) winnow-mode)
       "
