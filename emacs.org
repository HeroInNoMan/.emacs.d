    ...
    #+BEGIN_SRC emacs-lisp
      (use-package helm
        ...
        (defhydra hydra-helm-config(:color teal :hint nil)
          ...
          _q_uit    _/_ find       _o_ occur     _i_ imenu        _g_    google   _h i_ info      _p_ process
          ^ ^       _F_ files      _a_ ag grep   _I_ imenu all    _s_   surfraw   _h r_ emacs     _c_ colors
          ^ ^       _f_ all files  ^ ^           _._ imenu any    _w_ wikipédia   _h g_ gnus      _8_ ucs
          ^ ^       _m_ mini       ^ ^           _b_ bookmark     ^ ^             _h h_ doc       _,_ calcul
