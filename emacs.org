...
** Sql
   #+BEGIN_SRC emacs-lisp
     ...
     (defhydra hydra-format-sql(:color blue)
       ("q" nil "quit" :column "SQL")
       ("f" sqlformat "paragraph" :column "Format")
       ("b" sqlformat-buffer "buffer")
       ("r" sqlformat-region "region")
       ("i" sql-indent-buffer "indent")
       ("u" sql-upcase-buffer "buffer" :column "Upcase")
...
** Custom menu
   #+BEGIN_SRC emacs-lisp
     ...
     (defhydra hydra-minor-modes(:color blue)
       ...
       ("M" hide-mode-line-mode (format-mode-state "hide mode-line" 'hide-mode-line-mode))
