    ...
    (use-package god-mode
      ...
      (defun my-update-cursor ()
        ...
        (cond
         ...
         ((not god-local-mode)
          (progn
            (set-cursor-color "#51afef") ;; TODO aller choper dynamiquement la couleur de base du curseur (ou mieux définir une face cursor-color-god ou un truc comme ça)
            (setq god-mode-colors nil)))))
...
** Highlight feedback
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package highlight-line
       :ensure nil
       :hook (dired-mode . highlight-line-mode)
       :load-path "elisp/"
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package visual-regexp-steroids
       ...
       (("M-s r" . vr/replace)
        ...
        ("M-s R" . vr/isearch-backward)
        ("M-s S" . vr/isearch-forward))
...
** Magit
   #+BEGIN_SRC emacs-lisp
     (use-package magit
       ...
       :custom-face (magit-branch-current ((t (:foreground "#51afef" :box (:line-width (1 . 1) :color "#51afef" :style released-button)))))
      ...
      (defun open-calendar ()
        ...
        (cfw:open-calendar-buffer
         ...
         (list
          ...
          (cfw:org-create-source "DarkOliveGreen4")  ; orgmode source
          ;; (cfw:cal-create-source "Orange") ; diary source
          (cfw:ical-create-source "Moon" "http://cantonbecker.com/astronomy-calendar/astrocal.ics" "Gray")  ; ICS source1
          (cfw:ical-create-source "Perso" "https://framagenda.org/apps/calendar/p/KpjTmX4M9FX3QSYR" "DeepSkyBlue")))))
...
* Org-mode
  #+BEGIN_SRC emacs-lisp
    (use-package org
      ...
      (setq snippet-file (concat base-emacs-directory "code-snippets.org")
...
** Dealing with parens
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package smartparens
       ...
       (global-set-key (kbd "M-s a") 'sp-absorb-sexp)
       (global-set-key (kbd "M-s j") 'sp-join-sexp)
       (global-set-key (kbd "M-s |") 'sp-split-sexp)
       (global-set-key (kbd "M-s R") 'sp-raise-sexp)
       (global-set-key (kbd "M-s s") 'sp-splice-sexp)
     ...
     (pretty-hydra-define hydra-widgets
       ...
       ("Shells"
        ...
        (("p" list-packages "packages")
         ...
         ("I" crux-cleanup-buffer-or-region "cleanup buffer")
...
** Quitting
   ...
   Tangle config file when emacs quits so that it doesn’t eat startup time:
   #+BEGIN_SRC emacs-lisp
     ...
     (add-hook 'kill-emacs-hook 'ale/tangle-config-file)
   #+END_SRC
