...
* Org
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package org
      ...
      (setq org-agenda-weekend-days '(0 5 6)
      ...
      (setq org-agenda-custom-commands
            '(("E" occur-tree "emacs")
               ...
               ((agenda ""
                ...
                (alltodo ""
                         ((org-agenda-cmp-user-defined (cmp-date-property "CREATED"))
                          (org-agenda-sorting-strategy '(user-defined-down todo-state-up timestamp-down priority-down))
                          (org-agenda-overriding-header "Récent ↓")
              ...
              ("e" "Work (fortnight view)"
               ((agenda "" ;; block 1 Current fortnight
                        ((org-agenda-overriding-header "Agenda")
                         (org-agenda-start-on-weekday 1)
                         (org-agenda-weekend-days '(0 5 6))
              ...
              ("d" "Work (day view)"
               ((agenda "" ;; block 1 Current day
                ...
                (agenda "" ;; block 2 Current + next week
                        ((org-agenda-overriding-header "Agenda")
                         (org-agenda-start-on-weekday 1)
                         (org-agenda-weekend-days '(0 5 6))
                         ...
                         (org-agenda-sorting-strategy '(time-up priority-down))))
                (tags-todo "enercoop" ;; Block 3 All work-related TODO items
                           ((org-agenda-overriding-header "À faire")
                            (org-agenda-skip-function '(org-agenda-skip-entry-if 'deadline 'scheduled))
                            (org-agenda-sorting-strategy '(priority-down timestamp-up effort-up alpha-up)))))
               ((org-agenda-files `(,my-private-work-todo-org-file ,my-private-work-diary-org-file))
                (org-agenda-sorting-strategy '(priority-down))
                (org-agenda-skip-scheduled-if-deadline-is-shown t)
                (org-agenda-sticky nil) ;; a bit too slow to recreate every time
                (org-agenda-tag-filter '("+enercoop"))))
