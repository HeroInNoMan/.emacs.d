...
(add-to-list 'load-path (expand-file-name "~/.emacs.d/elisp/expand-region.el"))
(add-to-list 'load-path (expand-file-name "~/.emacs.d/elisp/multiple-cursors.el"))
...
;; Affiche l'heure en mode 24h et la date
...
;; Indenter automatiquement lorsque l'on appuie sur entrée pour le html
(add-hook 'html-helper-load-hook 'my-html-helper-load-hook)
;; pour que l'on n'ait pas à taper sur TAB pour indenter
