...
(easy-menu-define sml-mode-menu sml-mode-map "Menu used in `sml-mode'."
  '("SML"
    ("Process"
     ["Start SML repl"sml-runt]
     ["-" nil nil]
     ["Compile the project"sml-prog-proc-compilet]
     ["Send file"sml-prog-proc-load-filet]
     ["Switch to SML repl"sml-prog-proc-switch-tot]
     ["--" nil nil]
     ["Send buffer"sml-prog-proc-send-buffert]
     ["Send region"sml-prog-proc-send-regiont]
     ["Send function"sml-send-function t]
     ["Goto next error"next-errort])
