...
When called with a prefix argument, cleanup all known projects beforehand."
  ...
  (when (and (boundp 'my-default-project-root)
             (file-directory-p my-default-project-root))
  ...
  (when (and (boundp 'my-private-repos-dir)
             (file-directory-p my-private-repos-dir))
    (cl-loop for project in (f-directories my-private-repos-dir (lambda (dir) (projectile-root-bottom-up dir)))
             do (projectile-add-known-project project)))
  (when (and (boundp 'my-private-tools-dir)
             (file-directory-p my-private-tools-dir))
    (cl-loop for project in (f-directories my-private-tools-dir (lambda (dir) (projectile-root-bottom-up dir)))
             do (projectile-add-known-project project)))
  (when (and (boundp 'my-private-extra-repo-dir)
             (file-directory-p my-private-extra-repo-dir))
